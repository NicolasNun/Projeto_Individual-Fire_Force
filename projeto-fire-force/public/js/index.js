const personagens = {
  shinra: {
    ...
    gif: '<img src="./assets/gif_personagens/shinra.gif">',
    historia:
  ...
  arthur: {
    ...
    gif: '<img src="./assets/gif_personagens/arthur.gif">',
    historia:
  ...
  benimaru: {
    ...
    gif: '<img src="./assets/gif_personagens/benimaru.gif">',
    historia:
  ...
  joker: {
    ...
    gif: '<img src="./assets/gif_personagens/joker.gif">',
    historia:
  ...
  obi: {
    ...
    gif: '<img src="./assets/gif_personagens/obi.gif">',
    historia:
  ...
  maki: {
    apelido: "(Bruxa / Ogra)",
    gif: '<img src="./assets/gif_personagens/maki.gif">',
    historia:
  ...
  iris: {
    apelido: "(Irmã)",
    gif: '<img src="./assets/gif_personagens/iris.gif">',
    historia:
  ...
  tamaki: {
    apelido: "(Menina Gato)",
    gif: '<img src="./assets/gif_personagens/tamaki.gif">',
    historia:
...
function mudarPersonagem() {
  ...
  var { apelido, gif, historia, geracao, habilidade } = personagens[nome_personagem];

  apelidos.innerHTML = apelido;
  gif_personagem.innerHTML = gif;
  historiaPer.innerHTML = historia;
  geracao_personagem.innerHTML = geracao;
  texto_habiliade.innerHTML = habilidade;
}
